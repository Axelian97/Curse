...
/* ./.libs/lt-check_roots.c - temporary wrapper executable for .libs/check_roots
   Generated by libtool (GNU libtool) 2.4.6

   The check_roots program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check_roots"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_roots - temporary wrapper script for .libs/check_roots\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_roots program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"check_roots:check_roots:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_roots:check_roots:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_roots:check_roots:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
